...
/* 10. Напишите программу для проверки доступа пользователя к контенту на сайте, основываясь на возрасте, который он ввел самостоятельно. 
...
/* 11. Создайте программу для вычисления стоимости доставки товара в зависимости от его веса. 
...
/* 12. Создайте программу для определения, является ли день недели выходным. Получите от пользователя номер дня недели (целое число от 1 до 7, где 1 - понедельник, 7 - воскресенье). Используя тернарный оператор, определите, является ли этот день выходным, и выведите соответствующее сообщение:
...
/* 13. Создайте программу для оценки достижения пользователем цели. Пользователь вводит два числа: сначала количество выполненных задач, а затем количество поставленных изначально задач. Используя тернарный оператор, определите, достиг ли пользователь своей цели, и выведите соответствующее сообщение.
...
/* 14. Создайте программу для оценки скидки на товар в зависимости от его цены и статуса покупателя. Получите от пользователя сначала цену товара а затем статус покупателя (обычный или VIP). Используя вложенные условные операторы, выведите какую скидку получает покупатель:
...
/* 15. Создайте программу для оценки стоимости доставки товара в зависимости от его веса и статуса доставки. Запросите от пользователя вес товара и статус доставки (обычная или экспресс). Используя вложенные условные операторы, выведите стоимость доставки в зависимости от введенных данных:
