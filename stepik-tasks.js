...
/* 69. Напишите программу, которая запрашивает у пользователя ввод числа и проверяет, является ли введенное значение числом. 
...
/* 70. Пользователь вводит возраст. Напишите программу, которая проверяет, является ли введенное значение 
числом и находится ли оно в диапазоне от 18 до 65 лет включительно. 
Если введенное значение не является числом, программа выводит сообщение об ошибке: "Ошибка: Введите ваш возраст".
...
/* 71. Напишите программу, которая запрашивает у пользователя число, а затем вычисляет и выводит его квадратный корень. 
Если пользователь ввел отрицательное число, программа преобразует его в положительное. */
let num = Math.abs(Number(prompt("Введите число")));
let result = Math.sqrt(num);
console.log(`Квадратный корень из ${num} равен ${result}`);

/* 72. Напишите программу, которая запрашивает радиус круга у пользователя и вычисляет его площадь по формуле 
...
let result = Math.round(Math.pow(s, 3));
console.log(result);

/* 73. Перед вами массив fruits, в котором перечислены фрукты. 
...
/* 76. Перед вами программа, которая сначала запрашивает количество элементов массива, а затем 
элементы массива по одному соответствующее количество раз. 
...
for (let i = 0; i < numElements; i++) {
    userArray.unshift(prompt(i))
}

console.log(userArray);

/* 77. Перед вами программа, которая сначала запрашивает количество элементов массива, а затем элементы массива 
по одному соответствующее количество раз. 
...
/* 79. Запросите у пользователя произвольные строковые значения через запятую с пробелом 
...
*/
const userString = prompt("Введите произвольные значения через запятую с пробелом:");
let arr1 = userString.split(", ");
let beginItem = Number(prompt("Введите начальный элемент для среза:"));
let lastItem = Number(prompt("Введите конечный элемент для среза:"));
let arr2 = arr1.slice(beginItem, lastItem + 1);
...
const userString = prompt("Введите произвольные значения через запятую с пробелом:");
let arr1 = userString.split(", ");
let indexes = prompt("Введите индексы элементов для вывода:");
let arr2 = indexes.split(", ");
...
Используя метод filter, создайте новый массив, который будет содержать только те столицы, которые начинаются 
с буквы "А". Выведите массив.
*/
const capitals = [
  "Токио", "Афины", "Нью-Дели", "Сеул", "Джакарта", "Багдад", "Астана", "Москва", "Анкара"
];
let newArr = capitals.filter((elem) => {
    return elem[0] === "А";
}
);
console.log(newArr);
...
*/
let arr1 = prompt("Введите строковые значения через пробел:").split(" ");
...
Создайте массив из этих имен и используя метод map, создайте новый массив, в котором каждое имя будет иметь 
префикс "Пока, " добавленный перед именем. Затем выведите получившийся массив. */
let namesArr = prompt("Введите имена через запятую с пробелом:").split(", ");
let newArr = namesArr.map((elem) => {
    return elem = "Пока, " + elem;
});
console.log(newArr);

/* 88. Перед вами массив cities, содержащий названия городов. Напишите программу, которая запрашивает у пользователя название города и проверяет, есть ли такой город в массиве cities. Если город найден, программа должна вывести список городов, начинающихся с той же буквы, что и введенный пользователем город в заявленном формате.
...
let newArrCities = cities.filter((elem) => {
    if (cities.includes(cityName)) {
       return elem.startsWith(cityName[0]);
    }  
});
let citiesList = newArrCities.join(", ");

if (!cities.includes(cityName)) {
    console.log("Такого города нет в списке");
} else {
    console.log(`Города, начинающиеся с буквы "${cityName[0]}": ${citiesList}`);
}
...
let num = Number(prompt());
num == 100 ? console.log(num + 100) : console.log(num);
...
let num = Number(prompt());
num > 20 ? console.log(num * num) : console.log(num);
...
Високосный год - это год, который имеет одну дополнительную день, в феврале, по сравнению с обычными годами. 
Этот дополнительный день добавляется к 28 дням февраля, делая его длиной 29 дней. В обычных годах, февраль имеет 28 дней.
